...
use crate::memory::pkm::model::{
        ...
        let mut batch = Batch {
            ...
            playbooks: vec![
                NewPlaybookCandidate {
                    id: "restart".into(), path: "playbooks/restart-postgres".into(),
                    name: "Restart Postgres".into(), description: "Restart it safely".into(),
                },
                NewPlaybookCandidate {
                    id: "unused".into(), path: "playbooks/unused".into(),
                    name: "Unused".into(), description: String::new(),
                },
            ],
    ...
    fn research_coverage_records_supported_and_unsupported_claims_separately() {
        ...
        let sources = vec![transcript_source(
            ...
            TranscriptEvidenceKind::AgentMessage {
                message_id:"agent-1".into(), agent_id:"agent".into(), chat_id:"chat".into(),
            },
        )];
...
fn ingest_prompt_renders_with_exactly_the_vars_the_caller_supplies() {
    ...
    fn named_weekday_anchor_remains_unresolved() {
        ...
        let mut episode = Episode {
            ...
            anchor: TemporalAnchor { message: "m1".into(), quote: "next Sunday".into() },
            duration: None,
            absolute: None,
            resolved_start: None,
            resolved_end: None,
    ...
    fn source_specific_anchor_uses_its_declared_message() {
        ...
        let mut episode = Episode {
            status: EpisodeStatus::Planned,
            anchor: TemporalAnchor { message: "m1".into(), quote: "next week".into() },
        ...
        let sources = vec![
            TemporalSource { handle: "m1".into(), text: "London next week".into(), created_at: at, task_event_at: None, task_target_at: None },
            TemporalSource { handle: "m2".into(), text: "Paris next week".into(), created_at: at, task_event_at: None, task_target_at: None },
        ];
    ...
    fn planned_task_episode_resolves_to_its_target_time() {
        ...
        let mut episode = Episode {
            status: EpisodeStatus::Planned,
            anchor: TemporalAnchor { message: "m1".into(), quote: String::new() },
            duration: None,
            absolute: None,
            resolved_start: None,
            resolved_end: None,
