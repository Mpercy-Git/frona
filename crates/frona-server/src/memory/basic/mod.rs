...
impl BasicMemoryService {
    ...
    fn compaction_model_group(&self, chat_model_group: &str) -> Result<ModelGroup, AppError> {
        ...
        {
            Ok(group) => Ok(group.clone()),
            Err(crate::inference::error::InferenceError::ModelGroupNotFound(_)) => Ok(self
                .provider_registry
                .get_model_group(chat_model_group)?
                .clone()),
    ...
    async fn compaction_model_group_for_chats(
            ...
            .get_model_group(&self.memory_config.model_group)
        {
            ...
            Err(crate::inference::error::InferenceError::ModelGroupNotFound(_)) => {}
